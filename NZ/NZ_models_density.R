...
dens <- read.csv(file.path(nz_dir, "data", "longfin_density_data.csv"))
...
##################################
nz_dens_dir <- file.path(nz_dir, "waitaki_density")
dir.create(nz_dens_dir, showWarnings=FALSE)
setwd(nz_dens_dir)
...
## TEMPORAL GAMMA
########################
temp_dir <- file.path(nz_dens_dir, "temporal_gamma")
...
### TEMPORAL LOGNORMAL
###########################
temp_dir <- file.path(nz_dens_dir, "temporal_lognormal")
dir.create(temp_dir, showWarnings=FALSE)
setwd(temp_dir)
...
## SPATIAL GAMMA
##################
space_dir <- file.path(nz_dens_dir, "spatial_gamma")
...
## SPATIAL LOGNORMAL
##################
space_dir <- file.path(nz_dens_dir, "spatial_lognormal")
dir.create(space_dir)
setwd(space_dir)
...
#####################
## spatiotemporal
st_dir <- file.path(nz_dens_dir, "spatiotemporal_gamma")
dir.create(st_dir)
setwd(st_dir)
...
#####################
## spatiotemporal
st_dir <- file.path(nz_dens_dir, "spatiotemporal_spatial_gamma")
dir.create(st_dir)
setwd(st_dir)
